    ...
    >
      <div className="bg-white p-8 rounded-2xl border border-black/10 shadow-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-black/60 mt-2">Enter your details to access your account.</p>
          <p className="text-xs text-black/40 mt-1">Hint: use admin@example.com for admin access.</p>
        </div>
